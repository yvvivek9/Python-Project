                ...
                while not c:
                    ...
                    for i in R:
                        if te1.get() == i[0]:
                            ...
                            mechanical_marks.place(x=350,y=229)
                            evs_marks = Label(t_1, text=i[8])
                            evs_marks.place(x=350,y=262)
                            ...
                            for i in R:
                                ...
                                while t < 9:
                                    ...
                                    passmsg = Label(t_1, text='Congratulations! U have passed')
                                    passmsg.place(x=160, y=450)
                                    break
                                failmsg = Label(t_1, text='Sorry! U have failed')
                                failmsg.place(x=160, y=450)
                                break
                    ...
                    with open("STUDENT.DAT", "rb+") as F:
                        ...
                        while not c:
                            ...
                            for i in R:
                                if de1.get()!=i[0]:
                                        l.append(i)
                                mylabel999=Label(addorsee,text='Student has been deleted')
                                mylabel999.place(x=400,y=290)
                                break
                            c = True
                        if c==False:
                                  mymsg4 = Label(addorsee, text='Student not found')
                ...
                with open("STUDENT.DAT", "rb") as F:
                    ...
                    try:
                        while not c:
                            ...
                            t_12.geometry("1450x400")
                            scrollbar = Scrollbar(t_12)
                            scrollbar.pack(side=RIGHT, fill=Y)
                            ycord = 0
                            for i in R:
                                mylabel31 = Label(t_12, text=f"Name of the student: {i[1]}, Semister: {i[2]}, Physics marks: {i[3]}, Maths marks: {i[4]}, CSE marks: {i[5]}, Electrical marks: {i[6]}, Mechanical marks: {i[7]}, EVS marks: {i[8]} ", font=("Arial", 15))
                        ...
                        mylabel3 = Label(addorsee, text='Students not found')
                        mylabel3.place(x=250, y=300)
